pipeline {
    ...
    environment {
        ...
        REMOTE_HOST     = 'nontapat@35.247.188.2' // Replace with your actual username and remote IP.
        SSH_CREDENTIALS = 'ssh_volunteer' // Use the ID of the Jenkins stored SSH credentials Test-00.s-ss
    }
